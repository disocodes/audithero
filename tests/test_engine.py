...
from schads_audit.engine import calculate_entitlements,reconcile_pay_periods,assign_pay_periods
...
def test_pay_period_assignment():
 t=frames('2026-08-08 18:00','2026-08-08 22:00')[3].drop(columns=['pay_period_start','pay_period_end']);runs=[{'id':'P1','payPeriodStarting':'2026-08-03','payPeriodEnding':'2026-08-16'}];o=assign_pay_periods(t,runs);assert str(o.iloc[0].pay_period_start.date())=='2026-08-03'
