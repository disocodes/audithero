...
Write-Host "2. Complete config mappings and controlled historical registers."
Write-Host "3. databricks bundle run -t $Target connection_test"
Write-Host "4. databricks bundle run -t $Target audit_readiness"
Write-Host "5. Run a one-month historical validation sample."
Write-Host "6. Only then run the full multi-year audit and enable the monthly schedule."
